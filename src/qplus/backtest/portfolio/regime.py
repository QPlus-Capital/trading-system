...
concentrated in one bucket as a fragile peak.
    ...
    uv run python -m qplus.backtest.portfolio.regime
"""
...
from qplus.backtest.portfolio.curves import DAY_NS, load_daily_close  # noqa: E402
from qplus.backtest.portfolio.equity_report import edge_stats  # noqa: E402

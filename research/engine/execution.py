...
Run from the repo root::
    ...
    uv run python -m research.engine.execution config/backtest/rsi_wpr_bb_xauusd.py
...
from research.engine.montecarlo import (  # noqa: E402
    equity_curve,
    monte_carlo_paths,
    summarize,
)
...
def main(argv: list[str] | None = None) -> None:
    ...
    if not args:
        raise SystemExit("usage: python -m research.engine.execution <recipe.py>")
    path = Path(args[0])

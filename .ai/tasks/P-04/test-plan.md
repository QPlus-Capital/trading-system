...
| AC-08 | architecture map, mutation fast/critical, and cumulative R3 gates | RED: module/target absent | GREEN locally; Linux mutation pending |
...
| INV-05 | Linux mutation results for estimator and resampler patterns | RED: target absent | Pending Linux fast and critical results |

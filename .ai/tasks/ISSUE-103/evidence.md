...
HEAD: a6b94bb700f8973ba3c5b31cdf8b6cb040e7ce38
...
| `check` | `uvx --from rust-just just check` | 0 | Rebase HEAD: Ruff, strict mypy over 180 files, Vulture, and 1,207 tests passed; one Linux-only mutation test was correctly skipped on Windows. |
...
| `invariants` | `uvx --from rust-just just check-invariants` | 0 | Rebase HEAD: 313 critical invariant tests passed, including live risk, account identity, parity, sizing, path risk, regression, and readiness. |

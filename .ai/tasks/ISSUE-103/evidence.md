...
HEAD: de4c6859c67db9076bbbbb5f96f9d84936fbe5d9
...
| `check` | `uvx --from rust-just just check` | 0 | Post-#97 rebase: Ruff, strict mypy over 180 files, Vulture, and 1,209 tests passed; one Linux-only mutation test was correctly skipped on Windows. |
...
| `invariants` | `uvx --from rust-just just check-invariants` | 0 | Post-#97 rebase: 315 critical invariant tests passed, including live risk, account identity, parity, sizing, path risk, regression, and readiness. |

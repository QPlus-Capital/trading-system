...
HEAD: bfdd29023ae236e3855c70f430c8362a55d160ad
...
| `mutation-on-touched-critical` | Linux Critical mutation workflow run `29914375734` | 0 | GREEN: weakened-test probe, full critical mutation ratchet, and artifact upload passed |
...
properties passed twice. No production critical function changed; Linux run `29914375734` passed
the weakened-test probe, full critical mutation ratchet, and machine-readable artifact upload.

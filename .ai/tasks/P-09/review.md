...
| F4 | P2 | The preserved legacy drawdown denominator can use a same-day close peak reached after the intraday minimum; tracked by #91. | An account opening at 100,000, dipping to 99,000, then closing at 110,000 reports -10% instead of the chronological -1%. | NOT-APPLICABLE |
...
and pass against the final implementation. F4 is an existing methodology defect that P-09's
contract required this package to preserve; issue #91 owns the chronological-HWM correction and
its isolated numerical regression.
...
entrypoints. No unresolved in-scope P0-P3 builder finding remains. Claude's independent review
remains mandatory.

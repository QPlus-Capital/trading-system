...
| R-07 | P1 | Module-wide wildcards mutated CLI/orchestration code and produced 298 no-test mutants, contradicting the focused-scope requirement | Name the pure functions per scope in TOML and require survivor classifications | resolved |
...
Mutmut path list and the TOML policy. Linux execution exposed and resolved R-01 through R-07 rather than

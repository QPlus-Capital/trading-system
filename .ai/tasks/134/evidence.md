...
HEAD: e980734a3954046d4a301dcbfa49f35bb9cd534e
...
| `check` | PowerShell: `$env:PYTHONUTF8='1'; just --shell "C:\Program Files\Git\bin\sh.exe" check` after rebasing onto current `origin/main` at `87032dd` | 0 | Ruff passed; mypy passed over 195 source files; Vulture passed; pytest: 1,775 passed, 1 Mutmut-availability skip |
...
| `integration-tests` | Rebased `just check` (`uv run pytest -q` subcommand) | 0 | Full suite: 1,775 passed, 1 Mutmut-availability skip; #136 registry guards and #148's final audit-reference correction remain active |
